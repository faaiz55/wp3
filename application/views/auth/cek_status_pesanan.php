<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="<?= base_url('auth/'); ?>#home">LaundryQu</a>
    ...
    <div class="container text-white text-center">
        <form action="<?= base_url('auth/cekStatusPesanan'); ?>" method="post">
          <div class="form-group">
              <label for="kode_invoice">Masukkan Nomer Invoice</label>
            ...
            <div class="col-lg">
              <div class="modal-content">
                <div class="modal-body px-5">
                  ...
                  <table class="table">
                    <tr>
                      <td class="font-weight-bold">Nomer Invoice</td>
                      <td class="px-2"> : </td>
...
<footer class="bg-dark text-white p-4 mt-n5">
	<div class="container-fluid">
		<div class="row justify-content-center">
	    	...
	    	<h3 class="oleo-font">LaundryQu</h3>
	    	<div class="row">
	    		<div class="col-lg">
					<span>&copy; Copyright <?= date('Y'); ?> faiz & faisal.</span>
	    		</div>
	    	</div>
			</div>
			<div class="col-lg-6 my-3">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-5"><a class="text-white" target="_blank" href="https://api.whatsapp.com/send?phone=+6281329810814">+62 813 2981 0814</a></div>
        </div> 
        <div class="row text-left my-2">
          <div class="col-lg-4">
            <i class="fas fa-fw fa-map-marker-alt"></i> Alamat 
          </div>
          <div class="col-lg-8">Jl. Kalibener No.18 Purwokerto Timur</div>
        </div>
      </div>
		</div>
		<div class="row">
